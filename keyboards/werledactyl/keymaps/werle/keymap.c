...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT( 
		...
		KC_Z,        C(KC_X), C(KC_C), C(KC_V), KC_B,   KC_N,   KC_M,    KC_COMM, KC_DOT, KC_SLSH, 
		_______,     KC_LGUI, KC_LALT, KC_LCTL, KC_SPC, KC_ENT, KC_RCTL, KC_LBRC, KC_RBRC, _______,
		_______,     KC_CAPS, KC_TAB,  KC_LSFT, LOWER,  RAISE,  KC_BSPC, KC_MENU, KC_DEL, _______),
    ...
    _______, _______, _______, _______, _______, _______,KC_KP_0, KC_DOT,  KC_PPLS, _______
