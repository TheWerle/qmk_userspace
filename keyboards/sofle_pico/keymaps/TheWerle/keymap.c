...
/*
	 ...
	 * |LCTR|   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   ,  |   .  |   /  |  \ 	|
	 * --------------------+++-------------------/       /     \      \-----------------------------------------'
	 *            | LGUI | LAlt | LCTR | Enter  / Space /       \Enter \ RAISE |  [   |   ] | RGUI |
	 */
	...
	[_LOWER] = LAYOUT(
	  ...
	  _______,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5, KC_NUM,  KC_P7,  KC_P8,  KC_P9, KC_PAST,  KC_F12,
	  _______, KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_PERC, KC_CIRC, KC_P4,  KC_P5,  KC_P6, KC_PSLS,  KC_PIPE,
	  _______,  KC_EQL, KC_MINS, KC_PLUS, KC_LCBR, KC_DEL, KC_LBRC,  KC_P1,  KC_P2,  KC_P3, KC_PMNS,  _______,
	 ...
	 */
    [_RAISE] = LAYOUT(
    _______, _______, _______, _______, _______, _______, _______, _______, DB_TOGG, _______, _______, _______,
...
/* ADJUST
  ...
  //                    ╰───────────────────────────────────╯ ╰───────────────────────────────────╯
    ...
    {[0] = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU)}, 
     ...
     [3] = {ENCODER_CCW_CW(AU_PREV, AU_NEXT)},
