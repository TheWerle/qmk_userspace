...
/*
	...
	[_LOWER] = LAYOUT(
	  ...
	  _______,  KC_EQL, KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR, KC_LBRC, KC_P1,   KC_P2,   KC_P3,   KC_PMNS,  _______,
	  _______, _______, _______, _______, _______, RGB_TOG, _______, KC_KP_0, KC_PDOT, _______, KC_PPLS,  _______
	),
	/* RAISE
	 * ,----------------------------------------.                    ,-----------------------------------------.
	 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
